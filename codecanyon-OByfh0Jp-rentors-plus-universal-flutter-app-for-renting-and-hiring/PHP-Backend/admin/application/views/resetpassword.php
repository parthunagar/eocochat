      ...
      <div class="main_container">
        ...
        <div class="">
            <div class="clearfix"></div>
             ...
             <?php if ($this->session->flashdata('invalid_url')) { ?>
               <div id="mydiv" class="alert alert-danger marg-tp-60"><?= $this->session->flashdata('category_success') ?>
             Invalid Url
             </div>
             <?php } ?>
             ...
             <?php } ?>
                ...
                <div class="x_panel login-bg">
                  ...
                  <div class="x_content login-txt">
                    ...
                    <br />
                    <form class="form-horizontal form-label-left input_mask" action="<?php echo base_url('index.php/Admin/reset_my_password') ?>" method="POST"  data-parsley-validate>


                      
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback" style="margin-bottom: 4%">
                        <input type="password" id="new_pass" name="new_password" required = "" class="form-control has-feedback-right input2" id="exampleInputEmail1" placeholder="New Password" value = "" onblur="chackNewPass()" onkeyup="changeNewPass()">
                        <span class="fa fa-envelope form-control-feedback right icn-rht" aria-hidden="true"></span>
                        <span class="red-alert" id="err_new" style="display: none !important;">New password does't match the confirm password</span>
                      </div>


                      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback" style="margin-bottom: 4%">
                        <input type="password" id="confirm_pass" name="confirm_password" required = "" class="form-control has-feedback-right input2" id="exampleInputEmail1" placeholder="Confirm Password" value = "" onblur="chackConfirmPass()" onkeyup="changeConfirmPass()">
                        <span class="fa fa-envelope form-control-feedback right icn-rht" aria-hidden="true"></span>
                         <span class="red-alert" id="err_confirm" style="display: none !important;">Confirm password does't match the new password</span>
                        <span class="form-link"><a href="<?php echo base_url() ?>" >Back to Login</a></span>
                      </div>
                      <input type= "hidden" name="varified_code" value="<?php echo $verified_code;?>">
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <button type="submit" class="btn btn6 col-md-12 col-sm-12 col-xs-12" disabled="disabled" id="change_btn">Reset</button>
                        </div>
                      </div>
