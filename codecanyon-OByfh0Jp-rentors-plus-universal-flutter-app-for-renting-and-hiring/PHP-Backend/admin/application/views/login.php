      ...
      <div class="main_container">
        ...
        <?php if ($this->session->flashdata('msg')) { ?>
         ...
         <?php } ?>
          ...
          <?php if ($this->session->flashdata('used_url')) { ?>
           <div id="mydiv" class="alert alert-danger marg-tp-60"><?= $this->session->flashdata('category_success') ?>
         Activation link is already used. You can not use it again!
         </div>
         <?php } ?>
                ...
                <div class="x_panel login-bg">
                  ...
                  <div class="x_content login-txt">
                    ...
                    <br />
                    <form class="form-horizontal form-label-left input_mask" action="<?php echo base_url('index.php/Admin/login') ?>" method="POST"  data-parsley-validate>


                      
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback" style="margin-bottom: 4%">
                        <input type="email" name="email" required = "" class="form-control has-feedback-right input2" id="exampleInputEmail1" placeholder="Email" value = "admin@gmail.com">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback" style="margin-bottom: 4%">
                        <input required = "" type="password" name="password" class="form-control input2" id="exampleInputPassword1" placeholder="Password" value = "123456">


                        <span class="fa fa-key form-control-feedback right icn-rht" aria-hidden="true"></span>
                        <span class="form-link"><a href="<?php echo base_url('index.php/Login/forgotpassword') ?>" >Forgot Password?</a></span>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <button type="submit" class="btn btn6 col-md-12 col-sm-12 col-xs-12">Login</button>
                        </div>
                      </div>
