...
class Dbkeys {
  ...
  //------- SharedPrefence API data
  static final String sharedPrefEmail = 'sharedPrefApiEmail';
  static final String sharedPrefMobile = 'sharedPrefApiMobile';
  static final String sharedPrefUsername = 'sharedPrefApiUsername';
  static final String sharedPrefCountryCode = 'sharedPrefApiCountryCode';
  static final String sharedPrefAccountNumber = 'sharedPrefApiAccountNumber';
  static final String sharedPrefUpdatedAt = 'sharedPrefApiUpdatedAt';
  static final String sharedPrefCreatedAt = 'sharedPrefApiCreatedAt';
  static final String sharedPrefUserId = 'sharedPrefApiUserId';
  static final String sharedPrefFcmToken = 'sharedPrefFcmToken';
...
//--
  ...
  static final String groupsJoinedList = 'groupsJoinedList';
