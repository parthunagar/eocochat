...
import 'package:fiberchat/Reasturant/models/user_model.dart';
...
class SignUpScreenState extends State<SignUpScreen> {
  ...
  saveDataOfUser() async {
    ...
    if (widget.isFromLogin!) {
      ...
      if (await userService.isUserExist(emailCont.text)) {
        ...
        toast(getTranslated(context, 'lblUserAlreadyRegisterWithEmail'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(elevation: 0, backgroundColor: Colors.transparent, iconTheme: IconThemeData(color: context.iconColor)),
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(getTranslated(context, 'lblSignUp'), style: boldTextStyle(size: 30)),
                Container(
                  decoration: BoxDecoration(borderRadius: radius(), border: Border.all(color: context.dividerColor)),
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          child: Column(
                            children: [
                              AppTextField(
                                ...
                                // decoration: inputDecoration(context, label: language.lblName).copyWith(prefixIcon: IconButton(onPressed: null, icon: Icon(Icons.person_outline, color: secondaryIconColor))),
                                decoration: inputDecoration(context, label: getTranslated(context, 'lblName')).copyWith(prefixIcon: IconButton(onPressed: null, icon: Icon(Icons.person_outline, color: secondaryIconColor))),
                              ),
                              16.height,
                              AppTextField(
                                textInputAction: TextInputAction.next,
                              ...
                              widget.isFromLogin!
                                  ...
                                  : AppTextField(
                                      ...
                                      // decoration: inputDecoration(context, label: language.lblPassword).copyWith(prefixIcon: IconButton(onPressed: null, icon: Icon(Icons.password, color: secondaryIconColor))),
                                    decoration: inputDecoration(context, label: getTranslated(context, 'lblPassword')).copyWith(prefixIcon: IconButton(onPressed: null, icon: Icon(Icons.password, color: secondaryIconColor))),
                                    ),
                              16.height,
                              AppTextField(
                                focus: contactFocus,
                                ...
                                // decoration: inputDecoration(context, label: language.lblPhoneNumber).copyWith(prefixIcon: IconButton(onPressed: null, icon: Icon(LineIcons.phone, color: secondaryIconColor))),
                                decoration: inputDecoration(context, label: getTranslated(context, 'lblPhoneNumber')).copyWith(prefixIcon: IconButton(onPressed: null, icon: Icon(LineIcons.phone, color: secondaryIconColor))),
                              ),
                      ...
                      AppButton(
                          ...
                          text: getTranslated(context, 'lblSignUp'),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("${getTranslated(context, 'lblAlreadyHaveAccount')}?", style: secondaryTextStyle(size: 14)).flexible(),
                    TextButton(
                      // child: Text(language.lblSignInHere, style: boldTextStyle(size: 14)),
                      child: Text(getTranslated(context, 'lblSignInHere'), style: boldTextStyle(size: 14)),
                      onPressed: () {
                        finish(context);
                      },
                    ),
