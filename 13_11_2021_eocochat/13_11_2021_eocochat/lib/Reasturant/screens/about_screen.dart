  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appBarWidget(getTranslated(context, 'lblAbout'), color: context.scaffoldBackgroundColor),
          ...
          onSuccess: (data) => Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(getTranslated(context, 'lblRestaurantQRMenu'), style: boldTextStyle(size: 25)),
                16.height,
                Divider(height: 16, thickness: 4, color: primaryColor, endIndent: 250),
                16.height,
                // Text('${language.lblVersion}:', style: boldTextStyle()),
                Text('${getTranslated(context, 'lblVersion')}:', style: boldTextStyle()),
                ...
                AppButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(getTranslated(context, 'lblPurchase'), style: boldTextStyle(color: white)),
                    ],
                  ),
                ),
              ],
