        ...
        children: [
          ...
          ListTile(
            ...
            subtitle: Padding(
              ...
              child: Text(
                ...
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: TextStyle(fontSize: 14, color: fiberchatBlack.withOpacity(0.56))),
            ),
          ),
          ListTile(
            onTap: () {
          ...
          ListTile(
            ...
            leading: Padding(
              padding: const EdgeInsets.only(top: 6),
              child: Icon(
                Icons.lock_outline_rounded, color: fiberchatgreen.withOpacity(0.75), size: 26),
            ),
            title: Text(
          ...
          ListTile(
            ...
            contentPadding: EdgeInsets.fromLTRB(30, 3, 10, 3),
            leading: Icon(Icons.people_rounded, color: fiberchatgreen.withOpacity(0.75), size: 26),
            title: Text(
          ...
          observer.isLogoutButtonShowInSettingsPage == true
              ? ListTile(
                  ...
                  title: Text(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(fontSize: 16, color: fiberchatBlack, fontWeight: FontWeight.w600),
                  ),
                )
              : SizedBox(),
          SizedBox(
            ...
            children: <Widget>[
              ListTile(
                  ...
                  title: Row(
                      ...
                      children: [
                        Icon(Icons.star, size: 40, color: fiberchatBlack.withOpacity(0.56)),
                        Icon(Icons.star, size: 40, color: fiberchatBlack.withOpacity(0.56)),
                        Icon(Icons.star, size: 40, color: fiberchatBlack.withOpacity(0.56)),
                        Icon(Icons.star, size: 40, color: fiberchatBlack.withOpacity(0.56)),
                        Icon(Icons.star, size: 40, color: fiberchatBlack.withOpacity(0.56)),
                  ...
                  onTap: () {
                    ...
                    Platform.isAndroid
                        ? launch(ConnectWithAdminApp == true
                            ? observer.userAppSettingsDoc[Dbkeys.newapplinkandroid]
                            : RateAppUrlAndroid)
                        : launch(ConnectWithAdminApp == true
