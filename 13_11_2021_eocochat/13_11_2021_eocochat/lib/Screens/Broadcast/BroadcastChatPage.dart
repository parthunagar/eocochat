...
class _BroadcastChatPageState extends State<BroadcastChatPage>
  ...
  getImageFileName(broadcastID, timestamp) {
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                            ...
                            width:
                                textEditingController.text.isNotEmpty ? 10 : 80,
                            child: Row(
  ...
  Widget buildInputIos(
      BuildContext context, List<BroadcastModel> broadcastList) {
  ...
  Widget selectablelinkify(
    ...
    return SelectableLinkify(
      style: TextStyle(
          fontSize: fontsize,
          color: 'Message is deleted' == text ? Colors.grey : Colors.black87,
          height: 1.3,
          fontStyle: 'Message is deleted' == text
              ? FontStyle.italic
              : FontStyle.normal),
      text: text == 'Message is deleted'
          ? getTranslated(this.context, 'msgdeleted')
          : text!,
      textAlign: textalign,
      onOpen: (link) async {
        if (1 == 1) {
