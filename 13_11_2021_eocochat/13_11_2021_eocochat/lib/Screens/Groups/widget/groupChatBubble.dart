                  ...
                  isMe
                      ...
                      : Consumer<AvailableContactsProvider>(
                          builder: (context, contactsProvider, _child) =>
                              FutureBuilder(
                                  future: contactsProvider.getUserDoc(postedbyphone),
                                    ...
                                    if (snapshot.hasData &&
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          ...
                                          Navigator.push(context, new MaterialPageRoute(builder: (context) => new ProfileView(
                                              snapshot.data.data(), currentUserNo, model, prefs, firestoreUserDoc: snapshot.data)));
                                        },
                                        child: Container(
