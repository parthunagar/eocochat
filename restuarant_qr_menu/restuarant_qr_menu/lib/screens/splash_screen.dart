...
import 'package:qr_menu/screens/sign_in_screen.dart';
import 'package:qr_menu/screens/sign_up_screen.dart';
import 'package:qr_menu/screens/walk_through_screen.dart';
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Image.asset(appStore.isDarkMode ? AppImages.app_logo : AppImages.app_logo_dark, height: 150, width: 150).cornerRadiusWithClipRRect(defaultRadius),
            26.height,
